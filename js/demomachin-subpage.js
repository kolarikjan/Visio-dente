...
$(document).ready(function () {
    ...
    $('.section-block-textimage').owlCarousel({
        ...
        loop:true,
        rewind:true,
        navText:["<img src='www/web/img/arrow-dropdown-black.png' alt='slider arrow' class='section-block-textimage-prev'>","<img src='www/web/img/arrow-dropdown-black.png' alt='slider arrow' class='section-block-textimage-next'>"],
        margin:1,
        nav:false,
        dots:true
    });
